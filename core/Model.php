...
class Model extends Connection
{
    ...
    public function create(array $dados, $ver = 0)
    {
    ...
    public function update(array $dados, $ver = 0)
    {
    ...
    public function read($parametros = null, $campos = "*", $ver = 0, $id = false)
    {
